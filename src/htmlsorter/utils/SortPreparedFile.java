 ...
 * @author john
 */
package htmlsorter.utils;

import htmlsorter.data.Event;
import java.io.File;
        ...
        for (int row = 0; row < 48; row++) {
            for (int column = 0; column < 7; column++) {
                if (EventArray[row][column].isSubjectBlank()) {
                    ...
                    sb.append(EventArray[row][column].getEventName() + ",");
                    sb.append(EventArray[row][column].getStartDate() + ",");
                    sb.append(EventArray[row][column].getStartTime() + ",");
